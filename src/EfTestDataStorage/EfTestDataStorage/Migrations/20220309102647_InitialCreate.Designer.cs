...
namespace EfTestDataStorage.Migrations
{
    ...
    [Migration("20220309102647_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfTestDataStorage.Entities.ProjectEntities.Project", b =>
                {
                    ...
                    b.Property<string>("ProjectHealth")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("project_health");
            ...
            modelBuilder.Entity("EfTestDataStorage.Entities.ProjectEntities.ProjectTechnology", b =>
                {
                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uuid")
                        .HasColumnName("project_id");
